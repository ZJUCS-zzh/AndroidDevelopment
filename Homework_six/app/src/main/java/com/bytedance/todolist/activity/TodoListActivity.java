...
public class TodoListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new TodoListAdapter(new TodoListOperator(){
            @Override
            public void deleteTodoList(TodoListEntity entity){TodoListActivity.this.deleteTodoList(entity);}

            @Override
            public void updateTodoList(TodoListEntity entity){TodoListActivity.this.updateTodoList(entity);}
        });
        ...
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // TODO
                Intent intent =new Intent(TodoListActivity.this,TodoListWritten.class);
    ...
    private void deleteTodoList(final TodoListEntity entity){
        new Thread(){
            @Override
            public void run(){
                TodoListDao dao =TodoListDatabase.inst(getApplicationContext()).todoListDao();
                dao.deleteSome(entity);
                loadFromDatabase();
            }
        }.start();
    }

    private void updateTodoList(final TodoListEntity entity){
        new Thread(){
            @Override
            public void run(){
                TodoListDao dao =TodoListDatabase.inst(getApplicationContext()).todoListDao();
